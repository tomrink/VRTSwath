...
*/
{
  ...
  printf("num input sds: %d",this->num_input_sds);
  ...
  for (i = 0; i < this->num_input_sds; i++)
  {
	...
	LogInfomsg(msg);
      ...
      */
      ...
      input = OpenInputV(this->input_file_name, this->input_sds_name,
...
Param_t *CopyParamV(Param_t *param)
/* 
!C******************************************************************************
