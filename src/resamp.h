...
#define RESAMPLER_VERSION "v1.4.8 June 2018"
...
#define NDET_MBAND_VIIRS (16)
#define NFRAME_MBAND_VIIRS (3200)
#define NDET_IBAND_VIIRS (32)
#define NFRAME_IBAND_VIIRS (6400)
