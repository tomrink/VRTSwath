...
*/
{
  ...
  this->band_offset.l = 0.0;
  this->band_offset.s = 0.0;
...
/*
      this->buf[il][is].img.l = geoloc->img[il_geo][is_geo].l;
      this->buf[il][is].img.s = geoloc->img[il_geo][is_geo].s;
      this->buf[il][is].img.is_fill = false;
*/
    }
  }
