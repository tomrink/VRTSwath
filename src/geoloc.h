...
Geoloc_t *OpenGeolocSwathV(char *file_name);
Geoloc_t *SetupGeolocGridV(Space_def_t *space, Input_t *input, 
                          Kernel_t *kernel);
bool CloseGeolocV(Geoloc_t *this);
bool FreeGeolocV(Geoloc_t *this);
